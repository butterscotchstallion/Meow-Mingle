...
export function Matches() {
  ...
  return (
    <AppLayout mainClassName="flex-1 flex flex-col items-center justify-center px-4 py-6 gap-6">
      {loading && (
      ...
      {!loading && !error && !hasCurrent && (
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <h2 className="text-2xl font-bold text-purple-100">No more cats!</h2>
